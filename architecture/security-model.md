...
| Windows (x86_64) | Parser-level checks + handle-relative child resolution (Plan 084) | Reparse-point hardening qualification pending Plans 085–086; not for untrusted mutable public content |
