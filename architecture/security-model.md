...
| Windows (x86_64) | Parser-level checks + handle-relative child resolution (Plan 084) + directory enumeration (Plan 085) + adversarial qualification scaffold (Plan 086, 114 tests) | Independent safety review and profile promotion decision awaited; not for untrusted mutable public content until those human gates complete |
