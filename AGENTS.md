...
`plans/` has design plans 000–126 (historical/implementation records; Plans 112–118 form the consolidation roadmap; Plan 125 closes Windows qualification, support truthfulness, and final closure; Plan 126 is a narrow post-closure corrective pass for the native fast path and the manual release workflow).
