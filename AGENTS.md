...
- `0.2.0` is the historical initial pre-1.0 release; the 0.2.1 direct-server patch is published and downstream-qualified (Plans 270–273; evidence: `release/plan-272-downstream-embedding-qualification-closure.md`). Never publish this API line as `0.1.x`. Every performance/release claim names a profile (`docs/deployment.md`) + evidence.
