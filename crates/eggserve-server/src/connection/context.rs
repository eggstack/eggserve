...
//! (Plan 215: moved from compatibility core).
//!
...
use eggserve_primitives::connection_info::{Scheme, SocketEndpoints, TlsInfo};
use eggserve_primitives::proxy::ProxySourceKind;
...
/// untrusted headers unless a trusted-proxy policy explicitly
...
impl ConnectionContext {
    ...
    /// Convert into the per-request [`eggserve_primitives::connection_info::ConnectionInfo`].
    ///
    ...
    pub fn connection_info(&self) -> eggserve_primitives::connection_info::ConnectionInfo {
        let mut info = eggserve_primitives::connection_info::ConnectionInfo {
...
/// admission state.
///
/// Non-exhaustive: future transport outcomes may be added. Match with a
/// wildcard arm.
#[non_exhaustive]
