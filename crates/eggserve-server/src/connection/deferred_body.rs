...
pub(crate) fn spawn_deferred_tracker(
    ...
    tokio::spawn(async move {
        ...
        match shared.body_state() {
            eggserve_primitives::request_lifecycle::BodyLifecycleState::Complete => {
                ops.counters()
            ...
            eggserve_primitives::request_lifecycle::BodyLifecycleState::Abandoned
            | eggserve_primitives::request_lifecycle::BodyLifecycleState::Failed => {
                ops.counters()
