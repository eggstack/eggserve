//! Public runtime error types (Plan 215: moved from compatibility core).
//!
...
//!
//! `eggserve_core::server::errors` re-exports this module during the 0.x
//! line; this crate is the single implementation authority.
