//! Operational observability root (Plan 215: moved from compatibility core).
//!
//! Ownership:
...
//!
//! `eggserve_core::ops` re-exports this module during the 0.x line; this
//! crate is the single implementation authority (Plan 215 Workstream F).
...
/// [`crate::runtime::RuntimeState`]; the default runtime context clones the
...
///   [`crate::runtime::RuntimeState::with_ops`] or
///   [`crate::ServerBuilder::ops_context`]. Events, counters, sink
...
/// runtime ownership ([`crate::runtime::RuntimeState`], connection activity)
