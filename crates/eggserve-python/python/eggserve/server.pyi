...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    extra_response_headers: list[tuple[str, str]] | None
    def __init__(self, request: Any, client_address: tuple[str, int], server: Any, *, directory: str | None = ..., extra_response_headers: list[tuple[str, str]] | None = ...) -> None: ...
