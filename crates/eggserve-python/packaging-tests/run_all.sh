...
cp "$SCRIPT_DIR"/test_body_smoke.py "$WORK_DIR/"
...
TESTS=("test_imports.py" "test_server_smoke.py" "test_client_smoke.py" "test_cli_smoke.py" "test_lifecycle_smoke.py" "test_body_smoke.py" "test_api_stability.py" "test_boundary_hardening.py")
PASSED=0
FAILED=0
FAILURES=()
