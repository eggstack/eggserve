...
Other directories: `architecture/` (9 deep-dive docs), `docs/` (19 reference docs), `plans/` (24 plans, 000–022 + ROADMAP), `examples/`, `fuzz/`.
...
- **Plan count** — Plans 000–022 complete. Verify against `plans/` directory.
