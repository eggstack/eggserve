...
| Native HTTP/3/QUIC (opt-in `http3`; same-port UDP, TLS 1.3/`h3` ALPN) | — | — | experimental (Plan 190 in-process body/lifecycle corrections pass; independent-client, adversarial-wire, and cross-platform runtime evidence remain incomplete) | — | — | experimental | — |
