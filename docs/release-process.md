...
The published `0.2.2` patch repairs the experimental HTTP/Tower adapter
ownership boundary. Plans 274–275 and
`release/plan-275-http-tower-adapter-patch-publication-closure.md` record the
